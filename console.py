...
class DuntaCommand(cmd.Cmd):
    """Defines the Dunta command interpreter.
    Attributes:
    ...
    def default(self, arg):
        ...
        argdict = {
            ...
            "checkout": self.do_checkout,
            "make_payment": self.do_make_payment,
            "cancel_payment": self.do_cancel_payment,
            "create_review": self.do_create_review
        }
    ...
    def do_create(self, arg):
        ...
        elif argl[0] not in DuntaCommand.__classes:
    ...
    def do_update(self, arg):
       ...
       <class>.update(<id>, <dictionary>)
        ...
        if len(argl) == 0:
            print("** class name missing **")
            return False
        if argl[0] not in DuntaCommand.__classes:
            print("** class doesn't exist **")
            return False
        if len(argl) == 1:
            print("** instance id missing **")
